...
public partial class Settings : ConfigModule<Settings>
{
    ...
    {
        Validate(() => AutostartUutProcessor, value => {
            return value is true;
        });
    }
    ...
    public override void Load(ref Settings module)
    {
        ...
        try
        {
            if (File.Exists(module.LocalPath))
            {
                ...
                module = JsonSerializer.Deserialize<Settings>(jsonData);
            }
            ...
            foreach (KeyValuePair<string, ConfigProperty> property2 in module.Properties)
            {
                ...
                typeof(Settings).GetMethod("On" + text + "Changed", BindingFlags.Instance | BindingFlags.NonPublic)?.Invoke(module, new object[1] { propertyInfo.GetValue(module) });
            }
    ...
    {
        var onSavingEvent = typeof(ConfigModule<Settings>).GetField("OnSaving", BindingFlags.Instance | BindingFlags.NonPublic);
        var onSaveEvent = typeof(ConfigModule<Settings>).GetField("OnSave", BindingFlags.Instance | BindingFlags.NonPublic);
